...
//        } catch (Exception e) {
//            log.error(
//                    "Could not start the JobManager because the leader election service did not
// start.",
//                    e);
...
//                }
//                log.info(
//                        "Cancellation during initialization requested for job {}. Job will be
// cancelled once JobManager has been initialized.",
//                        jobGraph.getJobID());
//
...
//        // complete the result future with the information of the information of the terminated
// job
...
//
//    /**
//     * Marks this runner's job as not running. Other JobManager will not recover the job after
// this
//     * call.
//     *
...
//            if (shutdown) {
//                log.debug(
//                        "JobManagerRunner cannot be granted leadership because it is already shut
// down.");
//                return;
//            }
...
//                                        // lost leadership in the meantime, complete this
// operation
...
//        if (shutdown) {
//            log.debug("Ignoring starting JobMaster because JobManagerRunner is already shut
// down.");
//            return CompletableFuture.completedFuture(null);
//        }
//
...
//        checkState(jobMasterService == null, "JobMasterService must be null before being
// started.");
//        log.info(
...
//                                        new FlinkException(
//                                                "Cancellation failed because JobMaster
// initialization failed"));
//                            }
...
//        } else {
//            log.info(
//                    "Ignoring confirmation of leader session id because {} is no longer the
// leader. Shutting down JobMaster",
//                    getDescription());
...
//            if (shutdown) {
//                log.debug(
//                        "Ignoring revoking leadership because JobManagerRunner is already shut
// down.");
//                return;
//            }
...
//        if (shutdown) {
//            log.debug(
//                    "Ignoring revoking JobMaster leadership because JobManagerRunner is already
// shut down.");
